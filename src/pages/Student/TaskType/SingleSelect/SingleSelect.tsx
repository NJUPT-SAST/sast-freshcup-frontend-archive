...
import { Col, Row, Typography, Radio, RadioGroup } from '@douyinfe/semi-ui'
...
export default function SingleSelect() {
    ...
    const [TaskTitle, setTaskTitle] = useState(Tasks[1])
    ...
    return (
        <Row className='Task' type='flex' justify='center'>
            <Col span={14}>
                <Title heading={2} id='SingleSelect'>{TaskTitle}</Title>
                ...
                <RadioGroup onChange={onChange} value={value} aria-label="SingleSelect" style={{ marginTop: 30 }}>
