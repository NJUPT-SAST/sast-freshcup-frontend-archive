import { Col, Layout, Row, Button, Typography, TextArea } from '@douyinfe/semi-ui'
...
export default function Subjective() {
    ...
    return (
        <Row className='Task' type='flex' justify='center'>
            <Col span={14}>
                <Title heading={2} id='Subjective'>{TaskTitle}</Title>
                ...
                <TextArea maxCount={1000} style={{ marginTop: 30 }} />
            </Col>
        </Row>
    )
}